// ignore_for_file: library_prefixes, use_build_context_synchronously, avoid_function_literals_in_foreach_calls
...
class _ProfileScreenState extends State<ProfileScreen> {
            ...
            child: Container(
                ...
                child: Column(
                    ...
                    children: [
                      ...
                      const Divider(),
                      customListTile(Icons.restore, 'Restore backup', () {
                        showCustomDialog(
                      ...
                      // ),
                      // const Divider(),
                      customListTile(Icons.next_plan_rounded, 'Budget Planning',
                          () {
                        redirectToBudgetPage(context);
                      }, context),
  ...
  void redirectToBudgetPage(context) async {
    try {
      ...
      if (currentPageTransactions.isNotEmpty) {
        ...
        if (categorizedTransactionsMap!.length <= 1) {
          ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
            content: Text(
              'It should contain atleast 2 month of Transaction data',
              maxLines: 2,
            ),
          ));
        } else {
          categorizedTransactionsMap!.forEach((monthYearKey, transactions) {
            ...
            transactions.forEach((transaction) {
              ...
              int totalWants = 0;
              int totalSavings = 0;
              int totalExpensesOnOther = 0;
              int totalExpensesOnFood = 0;
              int totalExpensesOnShopping = 0;
              int totalExpensesOnTravelling = 0;
              int totalExpensesOnentertainment = 0;
              int totalExpensesOnPersonalCare = 0;
              int totalExpensesOnEducation = 0;
              int totalExpensesOnBillsUtil = 0;
              int totalExpensesOnInvestment = 0;
              int totalExpensesOnRent = 0;
              int totalExpensesOnTaxes = 0;
              int totalExpensesOnInsurance = 0;
              for (AllTransactionDetails transaction in transactions) {
                if (transaction.transactionCategory == 0 ||
                  ...
                  switch (transaction.transactionSubcategoryIndex) {
                    case 0:
                      totalExpensesOnOther += transaction.transactionAmount!;
                      break;
                    case 1:
                      totalExpensesOnFood += transaction.transactionAmount!;
                      break;
                    case 2:
                      totalExpensesOnShopping += transaction.transactionAmount!;
                      break;
                    case 3:
                      totalExpensesOnTravelling +=
                          transaction.transactionAmount!;
                      break;
                    case 4:
                      totalExpensesOnentertainment +=
                          transaction.transactionAmount!;
                      break;
                    case 5:
                      totalExpensesOnPersonalCare =
                          transaction.transactionAmount!;
                      break;
                    case 6:
                      totalExpensesOnEducation +=
                          transaction.transactionAmount!;
                      break;
                    case 7:
                      totalExpensesOnBillsUtil +=
                          transaction.transactionAmount!;
                      break;
                    case 8:
                      totalExpensesOnInvestment +=
                          transaction.transactionAmount!;
                      break;
                    case 9:
                      totalExpensesOnRent += transaction.transactionAmount!;
                      break;
                    case 10:
                      totalExpensesOnTaxes += transaction.transactionAmount!;
                      break;
                    case 11:
                      totalExpensesOnInsurance +=
                          transaction.transactionAmount!;
                      break;
                    default:
                  }
              ...
              PredictionHelper model = PredictionHelper(
                  ...
                  expensesOnOthers: totalExpensesOnOther,
                  expensesOnFood: totalExpensesOnFood,
                  expensesOnShopping: totalExpensesOnShopping,
                  expensesOnTravelling: totalExpensesOnTravelling,
                  expensesOnEntertainment: totalExpensesOnentertainment,
                  expensesOnPersonalCare: totalExpensesOnPersonalCare,
                  expensesOnEducation: totalExpensesOnEducation,
                  expensesOnBillUtils: totalExpensesOnBillsUtil,
                  expensesOnInvestment: totalExpensesOnInvestment,
                  expensesOnRent: totalExpensesOnRent,
                  expensesOnTaxes: totalExpensesOnTaxes,
                  expensesOnInsurance: totalExpensesOnInsurance);
                      ...
                      onTap: () {
                        if (formKey.currentState!.validate()) {
                          if (id == 0) {
                            ...
                            createFile(jsonData, masterPassword!, context);
                          } else {
                            masterPassword = masterPasswordController.text;
                            masterPassword =
                                (masterPassword! + UserData.currentUserEmail!);
                            ...
                            Navigator.pop(context);
                            masterPasswordController.clear();
                            importDatabase(masterPassword!, context);
                          }
                        } else {
                          masterPasswordController.clear();
                        }
  ...
  Future<void> createFile(List<Map<String, dynamic>> jsonData,
      String masterKeyOfFile, context) async {
  ...
  Future<void> removeTextFromFile(String fileId,
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        createFile(jsonData, masterKeyOfFile, context);
      } else {
        ScaffoldMessenger.of(context).showSnackBar(SnackBar(
          content: Row(
            children: [
  ...
  Future<void> importDatabase(String masterKeyToCheck, context) async {
...
Widget customListTile(
    IconData? icon, String? titleText, Function()? onTapFunction, context) {
  return ListTile(
      leading: Icon(
        icon,
        color: Theme.of(context).colorScheme.secondary,
